...
Public Interface ITaskService
    Function CreateTask(req As CreateTaskRequest, creatorId As Guid, projectId As Guid) As String
    ...
    Function GetProjectTasks(projectId As Guid, userId As Guid) As List(Of TaskDetailResponse)
